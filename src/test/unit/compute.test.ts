...
describe('Compute Jobs Database', () => {
  ...
  before(async () => {
    envOverrides = buildEnvOverrideConfig(
      ...
      [
        '[{"socketPath":"/var/run/docker.sock","resources":[{"id":"disk","total":10}],"environments":[{"storageExpiry":604800,"maxJobDuration":3600,"minJobDuration":60,"fees":{"1":[{"feeToken":"0x123","prices":[{"id":"cpu","price":1}]}]},"free":{"maxJobDuration":60,"minJobDuration":10,"maxJobs":3,"resources":[{"id":"cpu","max":1},{"id":"ram","max":1},{"id":"disk","max":1}]}}]}]'
      ]
    )

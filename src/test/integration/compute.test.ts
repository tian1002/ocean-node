    ...
    previousConfiguration = await setupEnvironment(
      ...
      buildEnvOverrideConfig(
        ...
        [
          ...
          '[{"socketPath":"/var/run/docker.sock","environments":[{"storageExpiry":604800,"maxJobDuration":3600,"minJobDuration":60,"resources":[{"id":"disk","total":10,"max":10,"min":0,"type":"disk"}],"fees":{"' +
      ...
      previousConfiguration = await setupEnvironment(
        ...
        buildEnvOverrideConfig(
          ...
          [
            ...
            JSON.stringify(['0xe2DD09d719Da89e5a3D0F2549c7E24566e947260']),
            `${homedir}/.ocean/ocean-contracts/artifacts/address.json`,
            '[{"socketPath":"/var/run/docker.sock","environments":[{"storageExpiry":604800,"maxJobDuration":3600,"minJobDuration":60,"resources":[{"id":"disk","total":10,"max":10,"min":0,"type":"disk"}],"access":{"addresses":["' +
              allowedAddress +
              '"],"accessLists":[]},"fees":{"' +
              DEVELOPMENT_CHAIN_ID +
              '":[{"feeToken":"' +
      ...
      previousConfiguration = await setupEnvironment(
        ...
        buildEnvOverrideConfig(
          ...
          [
            ...
            '0xc594c6e5def4bab63ac29eed19a134c130388f74f019bc74b8f4389df2837a58',
            `${homedir}/.ocean/ocean-contracts/artifacts/address.json`,
            '[{"socketPath":"/var/run/docker.sock","paymentClaimInterval":60,"environments":[{"storageExpiry":604800,"maxJobDuration":3600,"minJobDuration":60,"resources":[{"id":"disk","total":10,"max":10,"min":0,"type":"disk"}],"fees":{"' +
              DEVELOPMENT_CHAIN_ID +
              '":[{"feeToken":"' +
              paymentToken +
              '","prices":[{"id":"cpu","price":1}]}]},"free":{"maxJobDuration":60,"minJobDuration":10,"maxJobs":3,"resources":[{"id":"cpu","max":1},{"id":"ram","max":1},{"id":"disk","max":1}]}}]}]'
